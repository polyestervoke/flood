...
import {isFileChromecastable, isFileSubtitles, getChromecastContentType} from '@client/util/chromecastUtil';
              ...
              <Select
                ...
                onSelect={(id) => {
                  if (id === 'none') {
                    ...
                    setSelectedSubtitles(Number(id));
                  }
                }}>
